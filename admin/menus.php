                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered menus-table">
                            <thead>
                                <tr>
                                    <th scope="col">Nome da comida</th>
                                ...
                                <div class="panel-X">
                                    ...
                                    <div class="save-header-X">
                                        <div style="display:flex">
                                            ...
                                            <div class="title-container">Detalhes</div>
                                        </div>
                                    ...
                                    <div class="panel-body-X">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo (isset($_POST['menu_name']))?htmlspecialchars($_POST['menu_name']):'' ?>" placeholder="nome" name="menu_name">
                                            <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <label for="menu_category">categoria</label>
                                        ...
                                        <div class="form-group">
                                            <label for="menu_price">preço</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['menu_price']))?htmlspecialchars($_POST['menu_price']):'' ?>" placeholder="preço" name="menu_price">
                                            <?php
                                        ...
                                        <div class="form-group">
                                            <label for="menu_image">Imagem</label>
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['add_new_menu']) && $_SERVER['REQUEST_METHOD'] == 'POST')
                                                {
                                                    ...
                                                    if(!empty($_FILES['menu_image']['name']) && !in_array($image_extension,$image_allowed_extension))
                                                    {
                                                        ?>
                                                            <div class="invalid-feedback" style="display: block;">
                                                                A imagem tem que ser jpg ou png!
                                                            </div>
                                                        <?php
                                ...
                                <form method="POST" class="menu_form" action="menus.php?do=Edit&menu_id=<?php echo $menu['menu_id'] ?>" enctype="multipart/form-data">
                                    <div class="panel-X">
                                        ...
                                        <div class="panel-body-X">
                                            ...
                                            <div class="form-group">
                                                <label for="menu_name">nome</label>
                                                <input type="text" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" value="<?php echo $menu['menu_name'] ?>" placeholder="nome" name="menu_name">
                                                <?php
                                            ...
                                            <div class="form-group">
                                                <label for="menu_price">preço</label>
                                                <input type="text" class="form-control" value="<?php echo $menu['menu_price'] ?>" placeholder="preço" name="menu_price">
                                                <?php
