<?php
	...
	$pageTitle = 'Categorias de Comidas';
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <div id = 'required_category_name' class="invalid-feedback">
                                            <div>Nome necessário</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">cancelar</button>
                                    <button type="button" class="btn btn-info" id="add_category_bttn">Nova categoria</button>
                                </div>
                            </div>
                        </div>
                    </div>
		                                                    ...
		                                                    <div class="modal fade" id="<?php echo $delete_data; ?>" tabindex="-1" role="dialog" aria-labelledby="<?php echo $delete_data; ?>" aria-hidden="true">
		                                                        <div class="modal-dialog" role="document">
		                                                            <div class="modal-content">
		                                                                ...
		                                                                <div class="modal-body">
		                                                                    tem certeza? "<?php echo strtoupper($category['category_name']); ?>"?
		                                                                </div>
		                                                                <div class="modal-footer">
