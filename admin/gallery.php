                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="image_name_input" class="form-control" onkeyup="this.value=this.value.replace(/[^\sa-zA-Z]/g,'');" placeholder="nome"g name="image_name">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-info" id="add_image_bttn">nova imagem</button>
                            </div>
                        </div>
                    </div>
                </div>
