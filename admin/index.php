	...
	<div class="login">
		<form class="login-container validate-form" name="login-form" action="index.php" method="POST" onsubmit="return validateLoginForm()">
			...
			<div class="form-input">
				...
				<div class="invalid-feedback" id="username_required">usuario necessario</div>
			</div>
			...
			<div class="form-input">
				...
				<div class="invalid-feedback" id="password_required">senha necessária</div>
			</div>
			...
			<span class="forgotPW">Esqueceu a senha?<a href="#">Clique aqui</a></span>
