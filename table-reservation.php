        ...
        ?>
            ...
            <form method="POST" action="table-reservation.php">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="number_of_guests">Quantas pessoas?</label>
                            <select class="form-control" name="number_of_guests">
                                <option value="1" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>
                                    1
                                </option>
                                <option value="2" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>2</option>
                                <option value="3" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>3</option>
                                <option value="4" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>4</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="check_availability" style="visibility: hidden;">Disponibilidade</label>
